...
export default function BillPreview({ shopDetails, customer, billItems, removeItem, invoiceNum, onReset, onPrint, setAlert }) {
        ...
        <section className="panel bill-panel glass">
            ...
            <div className="actions">
                ...
                <button className="btn-success" onClick={onPrint}>
                    <i className="fa-solid fa-cloud-arrow-up"></i> Save & Print
                </button>
            </div>
        </section>
    )
